                  ...
                  {!searchTerm && (
                    <div className="flex items-center gap-2 overflow-x-auto py-1 no-scrollbar text-[10px] font-bold uppercase tracking-widest">
                      <button
                        ...
                        className={`shrink-0 flex items-center gap-1.5 px-4 py-2 rounded-xl border transition-colors ${drillPath.length === 0 ? "bg-blue-600 border-blue-600 text-white" : "bg-slate-100 border-transparent text-slate-500 hover:bg-slate-200 hover:text-slate-700"}`}
                      >
                  ...
                  <div className="p-4 border-b border-slate-200 bg-slate-100 flex flex-col gap-4 justify-between shrink-0">
                    ...
                    {!searchTerm && (
                      <div className="flex items-center gap-2 overflow-x-auto py-1 no-scrollbar text-[10px] font-bold uppercase tracking-widest">
                        <button
                          onClick={() => setDrillPath([])}
                          className={`shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg border transition-colors ${drillPath.length === 0 ? "bg-emerald-600 border-emerald-600 text-white" : "bg-slate-100 border-transparent text-slate-500 hover:bg-slate-200 hover:text-slate-700"}`}
                        >
                          <LayoutList className="w-3 h-3" />
                          SEMUA KATEGORI
                        </button>
                      ...
                      <div className="p-4 bg-slate-50 border-b border-slate-200/60 sticky top-0 z-10 text-left">
                        <div className="flex gap-1 bg-slate-50 p-1 rounded-2xl overflow-x-auto no-scrollbar">
                          <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl transition-all font-black text-[9px] uppercase tracking-widest whitespace-nowrap ${auditSidebarTab === "incoming" ? "bg-white text-emerald-600 shadow-sm border border-slate-200/70" : "text-slate-400 hover:text-slate-600"}`}
                          >
                            <Plus className="w-3.5 h-3.5" /> Stok Masuk
                          </button>
                          <button
                            onClick={() => setAuditSidebarTab("disposal")}
                            className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl transition-all font-black text-[9px] uppercase tracking-widest whitespace-nowrap ${auditSidebarTab === "disposal" ? "bg-white text-red-600 shadow-sm border border-slate-200/70" : "text-slate-400 hover:text-slate-600"}`}
                          >
                            <Trash2 className="w-3.5 h-3.5" /> Pemusnahan
                          </button>
                          <button
                            onClick={() => setAuditSidebarTab("transfer")}
                            className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl transition-all font-black text-[9px] uppercase tracking-widest whitespace-nowrap ${auditSidebarTab === "transfer" ? "bg-white text-blue-600 shadow-sm border border-slate-200/70" : "text-slate-400 hover:text-slate-600"}`}
                          >
                            <ArrowRightLeft className="w-3.5 h-3.5" /> Antar Cabang
                          </button>
                          <button
                            onClick={() => setAuditSidebarTab("logs")}
                            className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl transition-all font-black text-[9px] uppercase tracking-widest whitespace-nowrap ${auditSidebarTab === "logs" ? "bg-white text-amber-600 shadow-sm border border-slate-200/70" : "text-slate-400 hover:text-slate-600"}`}
                          >
                  ...
                  <div className="flex gap-1 bg-slate-100 p-1 rounded-2xl shadow-[inset_2px_2px_5px_#b8c2d0,inset_-2px_-2px_5px_#ffffff] dark:shadow-[inset_2px_2px_5px_#1c1e24,inset_-2px_-2px_5px_#34373f]">
                    {[
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl transition-all font-black text-[9px] uppercase tracking-widest ${posSubView === tab.id ? "bg-white text-blue-600 shadow-sm border border-slate-200/70" : "text-slate-400 hover:text-slate-600"}`}
                      >
                          ...
                          {DEFAULT_CATEGORIES.map((cat) => {
                            ...
                            return (
                              <button
                                ...
                                className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest whitespace-nowrap transition-colors ${
